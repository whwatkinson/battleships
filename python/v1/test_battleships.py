...
class TestBattleship:
    ...
    test_fleet = Fleet(
        [ship_0, ship_1, ship_2, ship_3, ship_4, ship_5, ship_6, ship_7, ship_8, ship_9]
    )
    ...
    def test_place_ship(self):
        ...
        for ship in test_fleet1.fleet:
            test_board = place_ship_at(
                ship.row, ship.column, ship.horizontal, ship.length, board, ship
            )
